                    ...
                    open: function (opts) {
                        ...
                        $q.all({
                            ...
                            if (options.showClose) {
                                template += '<div class="ngdialog-close" title="关闭"></div>';
                            }

                            $dialog = $el('<div id="ngdialog' + localID + '" class="ngdialog"></div>');
                            var contentHtml = (options.overlay ?
                                    '<div class="ngdialog-overlay"></div><div class="ngdialog-content" '+(options.width?'style="width:'+options.width+'"':'')+' role="document"><div class="panel"><div class="panel-heading"><strong>'+options.title+'</strong></div><div class="panel-body">' + template + '</div></div></div>' :
